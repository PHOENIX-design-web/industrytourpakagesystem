...
namespace industrytourpakagesystem
{
    public class DbOperation
    {
        ...
        public DbOperation()
        {
            // con.ConnectionString = "Data Source=.;Initial Catalog=santhisoft;Integrated Security=True;Pooling=False";
        ...
        internal DataTable exedatatable(object p)
        {
