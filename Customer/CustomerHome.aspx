<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/CustomerMaster.Master" AutoEventWireup="true" CodeBehind="CustomerHome.aspx.cs" Inherits="industrytourpakagesystem.Customer.CustomerHome" %>
    ...
    <div class="tm-page-wrap mx-auto">
            ...
            <div class="tm-container-outer tm-position-relative" id="tm-section-4">
                ...
                <form action="index.html" method="post" class="tm-contact-form">
                    ...
                    <div class="form-group">
                        <textarea id="contact_message" name="contact_message" class="form-control" rows="9" placeholder="Message" ></textarea>
                    </div>
