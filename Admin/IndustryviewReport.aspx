<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="IndustryviewReport.aspx.cs" Inherits="industrytourpakagesystem.Admin.IndustryviewReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" Height="212px" Width="1082px" DataKeyNames="industryid" CssClass="auto-style1" ForeColor="#333333">
