    ...
    <div class="loginBox"> <img class="user" src="https://i.ibb.co/yVGxFPR/2.png" height="100px" width="100px">
            ...
            <div class="inputBox">
               <%-- <input id="uname"   placeholder="Username">--%>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtpassword" ForeColor="Red"></asp:RequiredFieldValidator>
            </div>
            <asp:Button ID="Button1" CssClass="btn-success" runat="server" Text="Login" OnClick="Button1_Click1" />
            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="form-control" OnClick="LinkButton1_Click" CausesValidation="false">Forgot Password?</asp:LinkButton>  
