...
{  
   public partial class IndustryPass : System.Web.UI.Page
    {
        ...
        protected void Unnamed3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = db.exedatatable("select l.*,i.* from tblindustry i inner join tbllogin l on i.loginid=l.loginid  where i.email='" + txtemail.Text + "'");
